 ...
 * Slide booking widget: GROUP BEGIN
 *    Enable booking widget: Radio
 *    Enable booking widget '1': Yes
 *    Enable booking widget '2': No
 * Slide booking widget: GROUP END
 * Slider: GROUP BEGIN
