...
class MM_Component_Page {
	...
	public function get_tab( $component, $group_id, $id_tab, $register_fields, $group_tab ) {
		...
		for ( $i = 0; $i < count( $contents ); ++$i ) {
			if ( strtolower( $contents[$i]['val'] ) == 'group begin' AND ( strtolower( $contents[$i]['options']['type'] ) == 'repeating group' OR strtolower( $contents[$i]['options']['type'] ) == 'repeating meta group' ) ) {
